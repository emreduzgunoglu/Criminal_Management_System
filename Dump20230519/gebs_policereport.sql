...
CREATE TABLE `policereport` (
  `idpolicereport` int NOT NULL AUTO_INCREMENT,
  `nam_us_case` varchar(45) NOT NULL,
  `details` longtext NOT NULL,
  `date_last_contact` date NOT NULL,
  `location_last_seen` varchar(45) NOT NULL,
  `admin_idAdmin` int NOT NULL,
  PRIMARY KEY (`idpolicereport`,`nam_us_case`),
  KEY `fk_policereport_admin1_idx` (`admin_idAdmin`),
  CONSTRAINT `fk_policereport_admin1` FOREIGN KEY (`admin_idAdmin`) REFERENCES `admin` (`idAdmin`)
